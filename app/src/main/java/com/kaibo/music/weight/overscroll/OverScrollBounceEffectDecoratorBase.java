package com.kaibo.music.weight.overscroll;
...
import com.kaibo.music.weight.overscroll.adapters.IOverScrollDecoratorAdapter;
import com.kaibo.music.weight.overscroll.adapters.RecyclerViewOverScrollDecorAdapter;

import static com.kaibo.music.weight.overscroll.IOverScrollState.STATE_BOUNCE_BACK;
import static com.kaibo.music.weight.overscroll.IOverScrollState.STATE_DRAG_END_SIDE;
import static com.kaibo.music.weight.overscroll.IOverScrollState.STATE_DRAG_START_SIDE;
import static com.kaibo.music.weight.overscroll.IOverScrollState.STATE_IDLE;
...
public abstract class OverScrollBounceEffectDecoratorBase implements IOverScrollDecor, View.OnTouchListener {
    ...
    protected static final int MAX_BOUNCE_BACK_DURATION_MS = 1200;
    protected static final int MIN_BOUNCE_BACK_DURATION_MS = 400;
    ...
    protected class OverScrollingState implements IDecoratorState {
        ...
        public boolean handleMoveTouchEvent(MotionEvent event) {
            ...
            if (dt > 0) {
                // Sometimes (though rarely) dt==0 cause originally timing is in nanos, but is presented in millis.
    ...
    protected class BounceBackState implements IDecoratorState, Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
        protected final Interpolator mBounceBackInterpolator = new BezierInterpolator(0.165f, 0.84f, 0.44f, 1f);
