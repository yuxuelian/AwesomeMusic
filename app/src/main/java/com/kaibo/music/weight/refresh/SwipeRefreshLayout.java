...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void moveSpinner(float overscrollTop) {
        Log.d("moveSpinner", "moveSpinner  overscrollTop=" + overscrollTop);
        mTarget.layout(0, (int) overscrollTop, mTarget.getMeasuredWidth(), (int) (mTarget.getMeasuredHeight() + overscrollTop));
