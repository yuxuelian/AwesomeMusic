package com.kaibo.music.weight.overscroll.adapters;

import android.view.View;

import com.kaibo.music.weight.overscroll.HorizontalOverScrollBounceEffectDecorator;
...
public class ViewPagerOverScrollDecorAdapter implements IOverScrollDecoratorAdapter, ViewPager.OnPageChangeListener {
    ...
    public boolean isInAbsoluteEnd() {
        return mLastPagerPosition == mViewPager.getAdapter().getCount() - 1 && mLastPagerScrollOffset == 0f;
    }
