...
public class ImageUtils {
    ...
    public static Drawable createBlurredImageFromBitmap(Bitmap bitmap, int inSampleSize) {
        ...
        RenderScript rs = RenderScript.create(BaseApplication.Companion.getBaseApplication());
        ...
        return new BitmapDrawable(BaseApplication.Companion.getBaseApplication().getResources(), blurTemplate);
    }
