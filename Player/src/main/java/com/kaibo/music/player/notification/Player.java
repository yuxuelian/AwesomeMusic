...
import com.kaibo.music.player.playback.PlaybackListener;
...
public class Player implements MediaPlayer.OnErrorListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnPreparedListener {
    ...
    private boolean setDataSourceImpl(final MediaPlayer player, final String path) {
        ...
        } catch (IOException | IllegalArgumentException todo) {
